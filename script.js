...
console.log('User: js, pass: 1111');
console.log('User: jd, pass: 2222');
alert('IN ORDER TO ENTER PLEASE NOTE DOWN THE USERS & PASSWORDS');
alert('USER:  ab ,  PIN: 1111');
alert('USER:  jw ,  PIN: 2222');
